...
const BannerStausChangePopUp: React.FC<{
  onClose: () => void
  isOpen: boolean
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  isStatusChangeRow: any
  bannerStatusChange(): void
  bannerStatusChangeClick(): void
}> = (props) => {
  ...
  return (
    ...
    >
      ...
      <DialogActions sx={{ mb: 3 }}>
        <Button
          onClick={() => props.bannerStatusChange()}
          autoFocus
          variant="contained"
          className={'btnStyle'}
        >
        ...
        <Button
          onClick={() => props.bannerStatusChangeClick()}
          autoFocus
          variant="contained"
          className={'btnStyle'}
          color={'inherit'}
...
export default BannerStausChangePopUp
